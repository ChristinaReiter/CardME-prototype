    ...
    <div>
      ...
      <div style= {{display:"flex", flexDirection: "row", justifyContent: "space-between", marginTop: "180px"}}>
        ...
        <div style={{
          ...
          <FavoriteButton productObject={singleProduct? singleProduct : ""} favorites={favorites} setFavorites={setFavorites} userID={userID} singleProduct={true}></FavoriteButton>
        </div>
